    ...
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="lg:w-3/5 flex flex-col justify-center py-8 px-8">
        <div className="flex flex-col text-center lg:text-right">
          <h1 className="text-3xl mt-20 lg:text-4xl font-bold text-yellow-400 mb-2">Steven Jonathan</h1>

          <p className="typewriter text-gray-400 mb-3">
        ...
        <div className="flex flex-col items-center lg:items-end space-y-4 mt-2">
          ...
          <a href='#'>
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="mt-4 px-4 py-2 bg-yellow-400 rounded-lg hover:scale-110 hover:bg-white"
              onClick={() => null}
            >
              Contact Me
            </motion.button>
